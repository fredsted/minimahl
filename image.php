		...
		<div class="post" id="post-<?php the_ID(); ?>">
			...
			<div class="entry">
				...
				<p class="postmetadata alt">
					<small>
						<?php printf(__('This entry was posted on %1$s at %2$s and is filed under %3$s.', "minimahl"),  get_the_time(__('l, F jS, Y', "minimahl")), get_the_time(), get_the_category_list(', ')); ?>
						<?php the_taxonomies(); ?>
